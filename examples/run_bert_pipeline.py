...
def main(bert_model, conll_path, save_path, sense_lvl=2):
    logger = init_logger()
    ...
    print_results(evaluate_docs(docs_test_expl, test_preds, threshold=0.7))
    print_results(evaluate_docs(docs_test_expl, test_preds, threshold=0.9))
    ...
    print_results(evaluate_docs(docs_blind_expl, blind_preds, threshold=0.7))
    print_results(evaluate_docs(docs_blind_expl, blind_preds, threshold=0.9))
